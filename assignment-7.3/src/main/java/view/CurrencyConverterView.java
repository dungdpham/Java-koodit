...
public class CurrencyConverterView extends Application {
    ...
    private GridPane createUI(CurrencyConverterController controller) {
        ...
        ObservableList<String> currencyAbbreviation = FXCollections.observableList(controller.getAbbreviations());
        ...
        addButton.setOnAction(event -> controller.openAddCurrencyWindow());
    ...
    public void updateCurrencyList() {
        ObservableList<String> currencyAbbreviations = FXCollections.observableList(controller.getAbbreviations());
        sourceCurrencyChoice.setItems(currencyAbbreviations);
        targetCurrencyChoice.setItems(currencyAbbreviations);
    }
